  ...
  <div id="content" class="span-24 page-content">
    <div class="work-projects">
      ...
      <div class="project project--candeo span-6">
        ...
        <div class="project__text vspan-2">
          ...
          <p class="project__description">
            <span class="project__tye">Academic</span>
      ...
      <div class="project project--ecoplace span-12 last">
        ...
        <div class="project__text vspan-2">
          ...
          <p class="project__description">
            <span class="project__tye">Commercial</span>
      ...
      <div class="project project--villevivante span-24">
        ...
        <div class="project__text vspan-2">
          ...
          <p class="project__description">
            <span class="project__tye">Commission</span>
    ...
    <div class="work-projects">
      ...
      <div class="project project--ewm span-14">
        ...
        <div class="project__text vspan-2">
          <h3 class="project__name">EWM Application</h3>
          <p class="project__description">
            <span class="project__tye">Commercial</span>
      ...
      <div class="project project--fipo span-10 last">
        <div class="project__image vspan-6">
          <a href="#">Visit Project</a>
        </div>
        <div class="project__text vspan-2">
          <h3 class="project__name">Personal Finance Application</h3>
          <p class="project__description">
            <span class="project__tye">Commercial</span>
      ...
      <div class="project project--hellowallet span-10">
        ...
        <div class="project__text vspan-2">
          <h3 class="project__name">Hello Wallet Application</h3>
          <p class="project__description">
            <span class="project__tye">Commercial</span>
    ...
    <div class="work-projects">
      ...
      <div class="project project--wide span-8">
      ...
      <div class="project project--zhaw span-8">
        <div class="project__image vspan-14">
          <a href="#">Visit Project</a>
        </div>
        <div class="project__text vspan-2">
      ...
      <div class="project project--wef span-8 last">
      ...
      <div class="project project--snsf span-8 last">
        <div class="project__image vspan-4">
          <a href="#">Visit Project</a>
        </div>
        <div class="project__text vspan-2">
